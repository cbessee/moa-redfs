            ...
            <div class="sidebar-video">
                ...
                <div class="video-img">
					...
					<?php if (!empty( $bg_image )): ?>
						...
						<img src="<?php echo esc_url($bg_image); ?>" alt="<?php esc_html_e('video popup bg image', 'vorosa') ?>">
		...
		public function form($instance){ 
			...
			<div class="image_box_wrap" style="margin:20px 0 15px 0; width: 100%;">
				...
				<div class="image_box widefat">
					<img src="<?php if( !empty($bg_image)){echo esc_html($bg_image);} ?>" style="margin:15px 0 0 0;padding:0;max-width: 100%;display:inline-block; height: auto;" alt="<?php esc_html_e('', 'vorosa'); ?>" />
				</div>
