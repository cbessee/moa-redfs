	        ...
	        <?php echo wp_kses_post( $args['before_widget'] ); 
				...
				if ( !empty($image) ): ?>
        			...
        			<div class="sidebar-banner">
        				...
        				<?php if ($banner_link): ?><a href="<?php echo esc_url( $banner_link ); ?>"> <?php endif ?><img src="<?php echo esc_url( $image ) ; ?>" alt="<?php esc_html_e('Banner Image', 'vorosa'); ?>"><?php if ($banner_link): ?>
		...
		public function form($instance){ 
			...
			<div class="image_box_wrap" style="margin:20px 0 15px 0; width: 100%;">
				...
				<div class="image_box widefat">
					<img src="<?php if( !empty($image)){echo esc_html($image);} ?>" style="margin:15px 0 0 0;padding:0;max-width: 100%;display:inline-block; height: auto;" alt="<?php esc_html_e('', 'vorosa'); ?>" />
				</div>
